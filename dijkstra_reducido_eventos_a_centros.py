...
print("Existen 2 ocasiones en que un mismo nodo está asociado tanto a un evento como a un centro de salud.")
...
contador = 0
for i in range(24):
    lista_eventos_origenes = list(set(lista_nodos_eventos))
...
with open("diccionario_24_tiempos_rutas_eventos_a_centros.json", "w") as f:
